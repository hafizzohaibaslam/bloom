...
const StackedCardTestimonials = () => {
  ...
  return (
    <section className="bg-neutral-950 py-24 px-4 lg:px-8 grid items-center grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-4 overflow-hidden">
      <div className="p-4">
        <h3 className="text-neutral-300 text-5xl font-semibold font-righteous">What our customers think</h3>
      ...
      {Array.from(Array(numTracks).keys()).map((n) => {
        return (
          ...
          >
            {selected === n ? (
              <motion.span
                className="absolute top-0 left-0 bottom-0 bg-bloomYellow"
                initial={{
                  width: "0%",
                }}
                animate={{
...
const Card = ({
  ...
  const background = position % 2 ? "#171717" : "white";
